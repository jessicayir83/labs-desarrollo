...
function pasteHandler({
  ...
  if (mode !== 'INLINE') {
    ...
    if (content.indexOf('<!-- wp:') !== -1) {
      const parseResult = (0, _parser.default)(content);
